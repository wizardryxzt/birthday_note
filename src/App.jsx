...
const adjustToSaturday = (date) => {
  ...
  if (dow === 0 || dow === 6)
    return { adjusted: d, wasAdjusted: false, originalDow: dow };
  const offset =
    dow === 1 ? -2 : dow === 2 ? -3 : dow === 3 ? 3 : dow === 4 ? 2 : 1; // fri
          ...
          <div className="info-box">
            <div className="info-row">
              ...
              <span className="info-value">
                {formatDate(nextBday)}（{dayName(nextBday)}）
              </span>
            </div>
            <div className="info-row">
        ...
        <div className="card">
          ...
          <div className="result-box">
            ...
            <div className="result-row">
              ...
              <span className="r-value">
                {formatDate(plan.rawDate)}（{dayName(plan.rawDate)}）
              </span>
            </div>

            {plan.wasAdjusted && (
              <div className="adjust-tip">
                {plan.finalDate.toDateString() ===
            ...
            <div className="result-row highlight">
              ...
              <span className="r-value">
                {formatDate(plan.finalDate)}（{dayName(plan.finalDate)}）
              </span>
            </div>
          </div>
    ...
    if (step === 4) {
      return (
        <div className="card center">
          <h1>计划制定完成！</h1>
          <p className="sub">
            请记住在 <strong>{formatDate(plan.finalDate)}</strong>（
            {dayName(plan.finalDate)}）<br />
            制定你的生日聚会计划。
          </p>
